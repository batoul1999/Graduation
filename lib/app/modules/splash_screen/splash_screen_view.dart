...
@override  _StartViewState createState() => _StartViewState();
}

class _StartViewState extends State<SplashScreenView>
          ...
          Column(
            children: [
              ...
              AnimatedOpacity(
                ...
                child: Text(
                  'أرشفة ديوان كلية الهندسة المعلوماتية',
                  style: TextStyle(
                    color: Colors.white,
            ...
            child: AnimatedOpacity(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                 ...
                 child: Lottie.asset('assets/lottie/logo1.json')
               // child:  Icon(Icons.task,color: AppColors.mainBlue,size: 0.32.sw,)
              ),
            ),
          ),
        ],
