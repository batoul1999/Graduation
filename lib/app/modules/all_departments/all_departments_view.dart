...
class AllDepartmintsView extends GetView<AllDepartmentController>{
        ...
        child: CustomGradientContainer(
          child: Stack(
            children: [
                 CustomAppBar(
                text: "جميع الأقسام",
                onPressed: controller.getAllDepartment,
                isBool:true.obs,
              ),
              0.1.sw.pw,
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        decoration: BoxDecoration(
                          ...
                          child: Center(
                            child: Text(
                              controller.departmentsList[index].name??"لا يوجد اسم",
                              style: TextStyle(
                                fontSize: 16.sp,
  ...
  Future <void> departmentDialog ({required AllDepartments department})async{
    Get.defaultDialog(
      ...
      content: SizedBox(
        ...
        child: Padding(
          ...
          fontSize: 20
             ...
             0.015.sh.ph,
              Text(
                'عدد المهام المعلقة: ${department.pendingTasksCount.toString()}',
            style: const TextStyle(
            overflow: TextOverflow.fade,
            fontSize: 20
          ),
             ...
             0.015.sh.ph,
              Text(
                'عدد المهام المنتهية:${department.finishedTasksCount.toString()}',
             style: const TextStyle(
            overflow: TextOverflow.fade,
            fontSize: 20
          ),
             ...
             0.015.sh.ph,
              Text(
                'عدد المهام المرفوضة: ${department.rejectedTasksCount.toString()}',
            style: const TextStyle(
            overflow: TextOverflow.fade,
            fontSize: 20
          ),
            ...
            fontSize: 20
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  itemCount: department.employess!.length,
                  itemBuilder: (context,index){
                    return Container(
                      ...
                      padding: EdgeInsets.all(20.w),
                       decoration: BoxDecoration(
                        ...
                        border: Border(bottom: BorderSide(color: AppColors.blackColor, width: 1))
                        
                       ),
                      child: Text(
                        department.employess![index].name!,
                        style: TextStyle(
                          fontSize: 16.sp,
